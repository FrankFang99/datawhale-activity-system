/**
 * 6 维评分引擎 edge case 单测（Frank 27 16:22 反馈：v2 7 维 → v3 6 维）
 * 覆盖：刷分检测、极端输入、等级边界
 */
...
describe('6 维评分 · 刷分检测', () => {
  it('RC005 motivation 命中关键词但长度 <10 → 基础分（不刷分）', () => {
  ...
  it('RC005 motivation 命中关键词 + 长度 ≥5 → 正常计分', () => {
